...
urlpatterns = [
    ...
    path('auth-user/<int:id>/', AuthUserProfileRetrieve.as_view(), name='auth-user'),
    ...
    path('address/view/<int:user_id>/', UserAddressRetrieve.as_view(), name='user-address-view'),
